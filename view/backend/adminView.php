    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-3">
            <form class="text-center border border-light p-5" action="index.php?action=connexion" method="post">
                ...
                <!-- pseudo -->
                <input type="text" name="pseudo" required id="defaultLoginFormPseudo" class="form-control mb-4"
                    placeholder="Pseudo">
                <!-- Email -->
                <input type="email" name="email" required id="defaultLoginFormEmail" class="form-control mb-4"
                    placeholder="E-mail">
                <!-- Password -->
                <input type="password" name="pass" required id="defaultLoginFormPassword" class="form-control mb-4"
        ...
        <tbody>
            <tr>
                ...
                <td><em><a href="index.php?action=deleteArticle&amp;id=<?= $data['id']?>"><i
                    ...
                    <em><a href="index.php?action=editArticle&amp;id=<?= $data['id']?>"><i
